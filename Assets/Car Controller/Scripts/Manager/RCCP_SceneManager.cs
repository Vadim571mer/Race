...
public class RCCP_SceneManager : RCCP_Singleton<RCCP_SceneManager>
{
 ...
 activeMainCamera.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>();
    ...
    private IEnumerator CheckMT()
    {
        ...
        if (!mutlithreadingSupported)
            Debug.LogWarning(
                "Multithreading is disabled on this platform, async can't be used with it. Regular methods will be used.");
