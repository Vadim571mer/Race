...
public class RCCP_Component : MonoBehaviour, IRCCP_Component
{
    ...
    public virtual void Awake()
    {
        if (!CarController)
        {
            ...
            {
                Debug.LogError("Couldn't found RCCP_CarController in parent, this component named " + name +
                               " is disabled!");
                enabled = false;
            }
        }
    ...
    public void Register(RCCP_CarController carController, IRCCP_Component component)
    {
        if (!carController)
        {
            Debug.LogError("This component named " + component.ToString() +
                           " is missing RCCP_CarController on parent. Be sure this component is child object of the RCCP_CarController!");
            enabled = false;
            return;
        }
