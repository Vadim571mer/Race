        ...
        if (steeringWheel)
        {
            ...
            switch (steeringWheelRotateAround)
            {
                case SteeringWheelRotateAround.XAxis:
                    targetRotation = orgSteeringWheelRot *
                                     Quaternion.AngleAxis(CarController.steerAngle * steeringAngleMultiplier,
                                         -Vector3.right);
                    break;
            ...
            steeringWheel.transform.localRotation = Quaternion.Slerp(steeringWheel.transform.localRotation,
                targetRotation, Time.deltaTime * steeringAngleSmoother * 3f);
        }
    }
