...
public class RCCP_AeroDynamics : RCCP_Component
{
    ...
    private void FixedUpdate()
    {
        ...
        CarController.Rigid.AddRelativeForce(Vector3.down * downForce * Mathf.Abs(CarController.speed),
            ForceMode.Force);
        ...
        CarController.Rigid.AddRelativeForce(-Vector3.forward * correctedForce * CarController.direction,
            ForceMode.Force);
            ...
            if (CarController.transform.eulerAngles.z < 300 && CarController.transform.eulerAngles.z > 60)
            {
                ...
                if (autoResetTimer > autoResetTime)
                {
                    CarController.transform.SetPositionAndRotation(
                        new Vector3(CarController.transform.position.x, CarController.transform.position.y + 3,
